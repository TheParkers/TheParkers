...
class ParkingSpace(models.Model):
    ...
    area_code = models.CharField(max_length=20) #create index to search based on area_code faster.
    # our pricing model will use this code to figure out the pricing to select.
    lat = models.FloatField()
    long = models.FloatField()
    parking_features = models.OneToOneField(ParkingSpaceFeatures, blank=True, null=True, on_delete=models.CASCADE, related_name="parking_features")
